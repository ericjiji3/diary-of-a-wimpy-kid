...
import v56 from '../vids/v56.mp4';

function E56(){
    return(
        <div>
            <h1>4.11.22</h1>
            <span>Went to the gym today, and then worked on LMWW some. I respect da fuk outta Marcos/Jack for making such a detailed pricing sheet, it makes me believe in the company and want to make the website 
